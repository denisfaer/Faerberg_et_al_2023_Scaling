...
3. Change the name of the file in line 90 of ``bootsrap.py`` replacing *file_name_here* with the name of the formatted CSV file containing your data: make sure to keep the single quotation marks and DO NOT include the .csv extention.
